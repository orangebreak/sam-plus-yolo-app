...
class YoloDetector(
    ...
    init {
        ...
        val modelPath = "final_float32.tflite"
        val metadataPath = "final_metadata.yaml"
    ...
    override fun detect(image: TensorImage, imageRotation: Int): DetectionResult  {
        ...
        // The bounding boxes from the model are relative to the preprocessed image (ppImage).
        // We must scale them by the actual dimensions of ppImage.
        val imgW = ppImage.width.toFloat()
        val imgH = ppImage.height.toFloat()
